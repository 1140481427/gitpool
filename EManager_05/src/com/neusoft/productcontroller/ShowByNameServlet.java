...
/**
 * Servlet implementation class ShowByNameServlet
 */
...
public class ShowByNameServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageModel<T_Product_List> pm = ps.showProByName(pageNo, pageSize, name);
		...
		request.getRequestDispatcher("hname.jsp").forward(request, response);
	}
