...
<html>
	...
	<script type="text/javascript">
		function topPage() {
			window.self.location = "showzk?pageNo=${pm.topPageNo}";
			
		}
		
		function previousPage() {
			window.self.location = "showzk?pageNo=${pm.previousPageNo}";
		}
		
		function nextPage() {
			window.self.location = "showzk?pageNo=${pm.nextPageNo}";
		}
		
		function bottomPage() {
			window.self.location = "showzk?pageNo=${pm.bottonPageNo}";
		}
	...
	<body>
		...
		<div style="margin-left:120px" >
				...
				&nbsp;第<select onChange="if(!isNaN(this.value)){window.self.location = 'showzk?pageNo=' + this.value }">
