		...
		<input type="hidden" name="command" value="login" />
			<div id="div_main">
				<div style="margin-left: 25px;">
					...
					<div style="margin-top: 20px;margin-bottom: 20px;"><input name="autologin" type="checkbox" value="1" />自动登陆 <a style="margin-left: 145px;" href="csmregister.jsp">免费注册</a></div>
