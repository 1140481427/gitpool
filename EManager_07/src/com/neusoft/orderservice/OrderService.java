...
public class OrderService {
	...
	public Orderinfo showOrderByDesc(){
		return od.selectOrderByDesc();
	}
	
	public PageModel<Orderinfo> showOrderByLike(int pageNo,int pageSize,String likeName){
		return od.selectOrderByLike(pageNo, pageSize, likeName);
	}
}
